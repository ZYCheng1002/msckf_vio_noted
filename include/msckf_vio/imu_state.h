...
struct IMUState {
  ...
  StateIDType id;              // IMU状态的唯一标识符
  static StateIDType next_id;  // 下一个State的ID
  double time;                 // state记录下来的时间
  ...
  /// There three variables are used to modify the transition matrices to make the observability matrix have proper null
  /// space.
  ...
  /// The z axis of the body frame should point upwards. Normally, this transform should be identity.
